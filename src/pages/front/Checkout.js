...
function Checkout() {
  const { cartDate } = useOutletContext();
  const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        <div className="row justify-content-center flex-md-row flex-column-reverse">
          <form className="col-md-6" onSubmit={handleSubmit(Onsubmit)}>
            <div className="bg-white p-4">
              ...
              <form>
                <div className="mb-2">
                  <label for="ContactMail" className="text-muted mb-0 form-label">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="form-group form-check">
                  ...
                  <label className="form-check-label" for="ContactLorem">
                    Lorem ipsum dolor sit amet, consetetur
                  </label>
                </div>
                <div className="mb-2">
                  <label for="ContactName" className="text-muted mb-0 form-label">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="">
                  <label for="ContactPhone" className="text-muted mb-0 form-label">
                    Phone
                  </label>
                  <input
                    type="text"
              ...
              <form>
                ...
                <div className="form-check mb-2">
                  <input
                    ...
                    checked
                  />
                  <label className="form-check-label text-muted" for="gridRadios1">
                    WebATM
                  </label>
                </div>
                <div className="form-check mb-2">
                  <input
                    ...
                    value="option2"
                  />
                  <label className="form-check-label text-muted" for="gridRadios2">
                    ATM
                  </label>
                </div>
                <div className="form-check mb-2">
                  <input
                    ...
                    value="option3"
                  />
                  <label className="form-check-label text-muted" for="gridRadios3">
                    ApplePay
                  </label>
                </div>
              </form>
            ...
            <div className="d-flex flex-column-reverse flex-md-row mt-4 justify-content-between align-items-md-center align-items-end w-100">
              ...
              <a href="./checkout-success.html" className="btn btn-dark py-3 px-7 rounded-0">
                Lorem ipsum
              </a>
            </div>
          </form>
